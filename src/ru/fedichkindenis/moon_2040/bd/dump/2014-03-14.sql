...
CREATE TABLE IF NOT EXISTS `function` (
  ...
  `type_if` bigint(19) unsigned NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Функции используемые в игре для расчёта';
...
CREATE TABLE IF NOT EXISTS `game_link_resources` (
  ...
  `count_res` int(10) unsigned NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Связь игры и формул для ресурсов';
...
CREATE TABLE IF NOT EXISTS `link_resources` (
  ...
  `count_res` int(10) unsigned NOT NULL COMMENT 'Количество производимого ресурса',
