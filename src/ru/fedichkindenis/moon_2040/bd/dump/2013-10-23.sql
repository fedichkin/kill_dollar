...
INSERT INTO `game` (`id`, `name`, `max_player`, `start_date`, `finish_date`, `step`, `count_ppl`, `credit_ppl`, `credit_user`, `description`) VALUES
	(1, 'Тестовая игра №1', -1, '2013-10-25 00:00:00', '0000-00-00 00:00:00', '00:05:00', 20, 20, 50, 'Это первая тестовая игра');
