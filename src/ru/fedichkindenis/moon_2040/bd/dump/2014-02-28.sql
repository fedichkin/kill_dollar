...
CREATE TABLE IF NOT EXISTS `function` (
  ...
  `el_function` bigint(19) unsigned DEFAULT NULL,
  `operand` bigint(19) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `market_earth` (
  ...
  `function_sale` bigint(19) unsigned NOT NULL,
  `val` int(10) unsigned NOT NULL,
  `function_val` bigint(19) unsigned NOT NULL,
  `buy_cost` int(10) unsigned NOT NULL,
  `function_buy` bigint(19) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk$market$game$game` (`game`),
  KEY `fk$market$res$res` (`resources`),
  KEY `fk$market$func$func_cost` (`function_sale`),
  KEY `fk$market$func$func_val` (`function_val`),
  KEY `fk$market$func$func_buy` (`function_buy`),
  CONSTRAINT `fk$market$func$func_buy` FOREIGN KEY (`function_buy`) REFERENCES `function` (`id`),
  CONSTRAINT `fk$market$func$func_sale` FOREIGN KEY (`function_sale`) REFERENCES `function` (`id`),
