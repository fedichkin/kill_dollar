...
-- Дамп данных таблицы moon_2040.game_day: ~1 rows (приблизительно)
...
CREATE TABLE IF NOT EXISTS `game_link_resources` (
  ...
  `type_operation` int(10) NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `game_link_resources` (`id`, `game`, `resources`, `count_up`, `count_down`, `link_resources`, `type_operation`) VALUES
	(1, 1, 3, 8, 12, 4, 0),
	(2, 1, 4, 8, 12, 8, 1),
	(3, 1, 8, 8, 12, 12, 2),
	(4, 1, 5, 4, 6, 16, 3),
...
-- Дамп данных таблицы moon_2040.game_res_stat: ~17 rows (приблизительно)
...
-- Дамп данных таблицы moon_2040.game_statistics: ~1 rows (приблизительно)
...
CREATE TABLE IF NOT EXISTS `market_earth` (
  ...
  `val_end` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Дамп данных таблицы moon_2040.market_earth: ~6 rows (приблизительно)
/*!40000 ALTER TABLE `market_earth` DISABLE KEYS */;
INSERT INTO `market_earth` (`id`, `game`, `game_date`, `resources`, `sale_cost`, `val`, `buy_cost`, `val_end`) VALUES
	(1, 1, 2, 3, 20, 3000, 29, NULL),
	(2, 1, 2, 4, 20, 7000, 29, NULL),
	(3, 1, 2, 8, 20, 2500, 29, NULL),
	(4, 1, 2, 5, 20, 100, 29, NULL),
	(5, 1, 2, 6, 20, 100, 29, NULL),
	(6, 1, 2, 7, 20, 1200, 29, NULL);
...
CREATE TABLE IF NOT EXISTS `operation_game` (
  ...
  `count_res` int(10) unsigned DEFAULT NULL,
  `link_object` bigint(19) unsigned DEFAULT NULL,
  `link_goal` bigint(19) unsigned DEFAULT NULL,
  ...
  KEY `fk$oper_game$res$object` (`link_object`),
  ...
  KEY `fk$oper_game$link$link_goal` (`link_goal`),
  CONSTRAINT `fk$oper_game$game$game` FOREIGN KEY (`game`) REFERENCES `game` (`id`),
  CONSTRAINT `fk$oper_game$link$link_goal` FOREIGN KEY (`link_goal`) REFERENCES `link_resources` (`id`),
  CONSTRAINT `fk$oper_game$link$link_obj` FOREIGN KEY (`link_object`) REFERENCES `link_resources` (`id`),
...
-- Дамп данных таблицы moon_2040.ppl: ~100 rows (приблизительно)
...
-- Дамп данных таблицы moon_2040.resources_statistics: ~17 rows (приблизительно)
...
-- Дамп данных таблицы moon_2040.state_resources_ppl: ~100 rows (приблизительно)
...
-- Дамп структуры для таблица moon_2040.usr_attribute
DROP TABLE IF EXISTS `usr_attribute`;
CREATE TABLE IF NOT EXISTS `usr_attribute` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `usr` bigint(20) unsigned NOT NULL COMMENT 'ссылка на пользователя',
  `attr` int(10) unsigned NOT NULL COMMENT 'идентификатор атрибута',
  `val_str` varchar(64) DEFAULT NULL COMMENT 'сроковое значение атрибута',
  `val_num` decimal(10,0) DEFAULT NULL COMMENT 'числовое значение атрибута',
  `val_date` datetime DEFAULT NULL COMMENT 'значение атрибута дата',
  `sd` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'начало действия атрибута',
  `fd` timestamp NULL DEFAULT NULL COMMENT 'окончание действия атрибута',
  PRIMARY KEY (`id`),
  KEY `fk$usr_attr$usr$usr` (`usr`),
  CONSTRAINT `fk$usr_attr$usr$usr` FOREIGN KEY (`usr`) REFERENCES `usr` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Атрибуты пользователей';

-- Дамп данных таблицы moon_2040.usr_attribute: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `usr_attribute` DISABLE KEYS */;
/*!40000 ALTER TABLE `usr_attribute` ENABLE KEYS */;


-- Дамп структуры для таблица moon_2040.usr_friends
DROP TABLE IF EXISTS `usr_friends`;
CREATE TABLE IF NOT EXISTS `usr_friends` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `usr_first` bigint(20) unsigned NOT NULL COMMENT 'пользователь инициирующий отношение',
  `usr_second` bigint(20) unsigned NOT NULL COMMENT 'пользователь принимающий отношение',
  `friend` bit(1) NOT NULL COMMENT 'дружба / не дружба',
  `sd` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'время',
  PRIMARY KEY (`id`),
  KEY `fk$usr_fr$usr$usr_f` (`usr_first`),
  KEY `fk$usr_fr$usr$usr_s` (`usr_second`),
  CONSTRAINT `fk$usr_fr$usr$usr_f` FOREIGN KEY (`usr_first`) REFERENCES `usr` (`id`),
  CONSTRAINT `fk$usr_fr$usr$usr_s` FOREIGN KEY (`usr_second`) REFERENCES `usr` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Дружеские связи игроков';

-- Дамп данных таблицы moon_2040.usr_friends: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `usr_friends` DISABLE KEYS */;
/*!40000 ALTER TABLE `usr_friends` ENABLE KEYS */;
